...
const LoadingLogo = () => {
    ...
    return(
        <div className="relative w-[13rem] h-[13rem]">
            <div
                className="circle w-[6em] h-[6em] right-1 top-4 border-4 dark:border-white border-text_color rounded-full flex items-center justify-center absolute ">
                    +
            </div>
            <div
                className="circle w-[4.5em] h-[4.5em] left-0 top-3  border-4 dark:border-white border-text_color rounded-full flex items-center justify-center absolute ">
                    q1
            </div>
            <div
