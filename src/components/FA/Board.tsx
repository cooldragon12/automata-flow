...
const Board = () => {
    ...
    //     // console.log("From: ", from, ", To: ", to, "value: ", val)
    //     return (
            
    //         <Xarrow endAnchor={'left'} startAnchor={'right'}  strokeWidth={3} zIndex={-100} labels={val} path='straight' animateDrawing color={theme=== 'Dark'? "#3498DB":"#999"} key={index} start={from} end={to} />
