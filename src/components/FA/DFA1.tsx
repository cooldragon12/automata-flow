    ...
    return(
        <>
            ...
            <div className={`absolute flex justify-center items-center top-[30%] left-[1rem]`}>
                ...
                {/* Q1 */}
                <div className={`absolute flex justify-center items-center top-[10%] left-[20rem]`}>
                ...
                {/* Q2 */}
                <div className={`absolute flex justify-center items-center top-[50%] left-[20rem]`}>
                ...
                {/* Q3 */}
                <div className={`absolute flex justify-center items-center top-[10%] left-[40rem]`}>
                ...
                {/* Q4 */}
                <div className={`absolute flex justify-center items-center top-[50%] left-[40rem]`}>
                ...
                {/* Q5 */}
                <div className={`absolute flex justify-center items-center top-[10%] left-[60rem]`}>
                    <State id={'q5'} state={'q5'} finalState={state.dfa.F.includes('q5')} valid={state.dfa.path[state.simulation.step] === 'q5' ? true:false}/>
                </div>
                <Xarrow _cpx2Offset={-30} _cpx1Offset={-30}  endAnchor={'left'} startAnchor={'right'}  strokeWidth={3} zIndex={-100} labels="a,b" path='smooth' 
                        animateDrawing color={theme=== 'Dark'? "#3498DB":"gray"} key={'q5.b'} start={'q5'} end={'q8'} />
                
                {/* Q6 */}
                <div className={`absolute flex justify-center items-center top-[50%] left-[60rem]`}>
                    <State id={'q6'} state={'q6'} finalState={state.dfa.F.includes('q6')} valid={state.dfa.path[state.simulation.step] === 'q6' ? true:false}/>
                </div>
                <Xarrow _cpx2Offset={30} _cpx1Offset={30} endAnchor={'right'} startAnchor={'right'}  strokeWidth={3} zIndex={-100} labels="a,b" path='smooth' 
                        animateDrawing color={theme=== 'Dark'? "#3498DB":"gray"} key={'q6.a'} start={'q6'} end={'q8'} />
           
                {/* Q7 */}
                <div className={`absolute flex justify-center items-center top-[30%] left-[50rem]`}>
                ...
                {/* Q8 */}
                <div className={`absolute flex justify-center items-center top-[30%] right-[2rem]`}>
                    <State id={'q8'} state={'q8'} finalState={state.dfa.F.includes('q8')} valid={state.dfa.path[state.simulation.step] === 'q8' ? true:false}/>
                </div>
                {/* QT */}
                <div className={`absolute flex justify-center items-center top-[30%] left-[30rem]`}>
                    <State id={'qT'} state={'qT'} finalState={state.dfa.F.includes('q8')} valid={state.dfa.path[state.simulation.step] === 'qT' ? true:false}/>
                </div>
