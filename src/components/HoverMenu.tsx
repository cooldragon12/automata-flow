    ...
    <>
      <menu className={`flex justify-center border border-text_color dark:border-primary rounded-md fixed shadow-background 
          ...
          <div className="flex justify-center items-center outline-inherit border-inherit relative">
            ...
            <input onChange={(e)=>dispatch({type:"ENTERED_INPUT",payload:{selection:"1", currentInput:e.target.value}})} disabled={state.simulation.simulating} type="text" placeholder='Validaty' className={`bg-inherit border border-inherit rounded-lg p-3 m-2 w-[100%] focus-visible:outline-inherit `} />
          </div>
