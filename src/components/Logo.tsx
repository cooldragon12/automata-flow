...
export default function Logo() {
    return (
        <div className="flex items-center justify-center hover:cursor-pointer dark:text-white">
            ...
            <p className="text-inherit font-bold text-lg first-letter:text-accent checked:bg-success checked:border-success hover:drop-shadow-md hover:shadow-accent">AUTOMATA</p> 
